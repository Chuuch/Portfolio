...
function ExperienceCard({ experience }: Props) {
	return (
		<article
			className="flex flex-col rounded-lg items-center space-y-4 md:space-y-10 flex-shrink-0
            w-72 h-[420px] md:w-[450px] md:h-[550px] lg:w-[500px] xl:w-[500px] xl:h-[600px]
            snap-center bg-gray-100 dark:bg-transparent border border-gray-300 dark:border-gray-700
            p-10 cursor-pointer transition-opacity duration-200 overflow-hidden"
		>
			<motion.img
